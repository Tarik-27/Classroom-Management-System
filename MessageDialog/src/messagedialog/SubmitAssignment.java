...
public class SubmitAssignment extends JFrame{
    ...
    public void Mark()
    {
         ...
         Assignments = new JComboBox (type);
         Assignments.setBounds(150,100,200,50);
         Assignments.setFont(f);
         Assignments.setForeground(Color.BLUE);
         c.add(Assignments);
    ...
    public static void main(String[] args) {
         ...
         SubmitAssignment frame = new SubmitAssignment();
         frame.setVisible(true);
    }
